  ...
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" style={{ overflow: "visible", display: "block" }}>
      ...
      <g style={{ userSelect: "none" }}>
        <text x="32" y="42" fill="#1D397A" fontSize="9" fontWeight="900" fontFamily="'Outfit','Inter',sans-serif" letterSpacing="-0.2">mobi</text>
        <text x="32" y="51" fill="#E4002B" fontSize="9" fontWeight="900" fontFamily="'Outfit','Inter',sans-serif" letterSpacing="-0.2">fone</text>
        <text x="73" y="49" fill="#1D397A" fontSize="17" fontWeight="900" fontFamily="'Outfit','Inter',sans-serif">AI</text>
      </g>

      <path d="M 23,60 A 37,37 0 0,1 97,60" fill="none" stroke="url(#headphoneGrad)" strokeWidth="6" strokeLinecap="round" />
      <rect x="52" y="18" width="16" height="5" rx="2.5" fill="#E1F5FE" />
      <path d="M 37,64 C 44,60 76,60 83,64 C 91,71 87,86 60,86 C 33,86 29,71 37,64 Z" fill="url(#headphoneGrad)" filter="url(#shadowEffect)" />
      ...
      <ellipse cx={45 + px} cy={71 + py} rx="7" ry={7 * eyeScaleY} fill="url(#eyeIris)" filter="url(#glowEffect)" style={{ transition: "ry 0.1s, cx 0.25s, cy 0.25s" }} />
      ...
      <ellipse cx={75 + px} cy={71 + py} rx="7" ry={7 * eyeScaleY} fill="url(#eyeIris)" filter="url(#glowEffect)" style={{ transition: "ry 0.1s, cx 0.25s, cy 0.25s" }} />
      ...
      {isHappy ? (
        <path d="M 52,78 Q 60,85 68,78" stroke="#00E5FF" strokeWidth="2" fill="none" strokeLinecap="round" />
      ) : mouthOpen ? (
        ...
        <path d="M 54,78.5 Q 60,82.5 66,78.5" stroke="#00E5FF" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      )}
      ...
      <path d="M 18,68 Q 18,97 50,96" fill="none" stroke="url(#headphoneGrad)" strokeWidth="3.2" strokeLinecap="round" />
